...
@note Concrete subclasses that inherit from BaseState must implement the
...
public abstract class BaseState
{
    ...
    protected BaseState CurrentSubState { get { return _currentSubState; } set { _currentSubState = value; } }
    protected BaseState CurrentSuperState { get { return _currentSuperState; } set { _currentSuperState = value; } }

    ////functions

    ///@brief Constructor for BaseState.
